    ...
    <div className="outer-wrapper" ref={divRef}>
      <picture>
        <source
          ...
          srcSet={theme === 'light' ? bgDesktopLigth : bgDesktopDark}
        />
        <source
          media="(max-width: 375px)"
          srcSet={theme === 'light' ? bgMobileLigth : bgMobileDark}
        />
        <img
          style={width > 425 ? { minHeight: '300px' } : { minHeight: '200px' }}
          src={theme === 'light' ? bgDesktopLigth : bgDesktopDark}
          alt="Desktop bg"
        />
      </picture>
      {children}
